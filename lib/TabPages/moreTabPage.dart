  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        //                 CustomerList testModel =
        //                     CustomerList.fromJson(snapshotData);
        //
        //                 List<String> aa = ['Select One'];
        //                 List<String> firstname1 = [];
        //                 // List<int> ids = [];
        //
        //                 List<String> firstname = [];
        //                 for (var i = 0; i < testModel.results!.length; i++) {
        //
        //                   firstname1
        //                       .add(testModel.results![i].firstName.toString());
        //                   // ids.add(testModel.results![i].id ?? 0);
        //                   firstname = aa + firstname1;
        //                   //log("hjghjgjk${firstname}");
        //
        //                 }
        ...
        //                 ItemsList itemModel = ItemsList.fromJson(snapshotData);
        //
        ...
        //                 for (var i = 0; i < itemModel.results!.length; i++) {
        //                   CircularProgressIndicator();
        //                   itemsList1.add(itemModel.results![i].name.toString());
        //                   // ids.add(testModel.results![i].id ?? 0);
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child:
                  (Text('New Customer',style: TextStyle(fontSize: 14,
                      color: Colors.grey,
                      fontWeight: FontWeight.bold),)),
